 ...
 */
public class RoundLightBarView2 extends ImageView {
    ...
    public RoundLightBarView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

    }

    public RoundLightBarView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private void initPaint() {
        ...
        //圆半径
        mCircleR = DensityUtils.px2dp(mContext, 20);
