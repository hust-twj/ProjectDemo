...
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    private float topLeftRadius = DensityUtils.dp2px(getContext(), 20);
    private float topRightRadius = DensityUtils.dp2px(getContext(), 20);
    private float bottomLeftRadius = DensityUtils.dp2px(getContext(), 20);
    private float bottomRightRadius = DensityUtils.dp2px(getContext(), 20);
